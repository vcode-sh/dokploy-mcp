...
export const v3ParityTarget = Object.freeze({
  ...
  source: Object.freeze({
    ...
    commit: 'a0a2b8f17152a78f225562d4ae197e8092d61c2e',
    sha256: 'e3989c3219cded91427448d4c62adb04d1b3920648c4d05befb78f64aabcf042',
  }),
})
...
export function normalizeOpenApiSource(parsed) {
  if (
    parsed &&
...
export function buildSchemasTs(procedureSchemas) {
  const escapedSchemasJson = escapeForSingleQuotedString(JSON.stringify(procedureSchemas))
  ...
  return [
    ...
    '}',
    '',
    `export const procedureSchemas = JSON.parse('${escapedSchemasJson}') as Record<string, ProcedureSchema>`,
    '',
